...
// Modified by nelinory to support ImageSharp image format instead of System.Drawing/System.Drawing.Imaging Bitmap
// https://github.com/nelinory/SupernoteSharp
...
{  /// <summary>
   ...
   /// </summary>
    ...
    public class Potrace
    {
        ...
        static void ConvertBitmap(Image<Rgb24> bitmap)
        {
            ...
            bitmap.ProcessPixelRows(accessor =>
            {
                for (int y = 0; y < accessor.Height; y++)
                {
                    ...
                    for (int x = 0; x < pixelRow.Length; x++)
                    {
                        ...
                        Result[index] = luminance < Treshold * 255 ? (byte)1 : (byte)0;
                        index++;
                    }
                }
            });
     ...
     segment */
       ...
       on failure. */
        ...
        public static void Potrace_Trace(Image<Rgb24> Bitmap, List<List<Curve>> ListOfCurveArrays)
        {
        ...
        public static string getPathTag(string colorHex)
        {
            double size = 1;
            int len = pathlist.Count;
            privcurve c;
